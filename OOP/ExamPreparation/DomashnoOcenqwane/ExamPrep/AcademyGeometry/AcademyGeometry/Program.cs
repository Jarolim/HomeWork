    ...
    public class AdvancedFigureController : FigureController
    {
        ...
        protected override void ExecuteFigureInstanceCommand(string[] splitCommand)
        {
            switch (splitCommand[0])
            {
                case "area":
                    {
                        var currentAsIAreaMeasureable = this.currentFigure as IAreaMeasurable;
                        if (currentAsIAreaMeasureable != null)
                        {
                            Console.WriteLine("{0:0.00}", currentAsIAreaMeasureable.GetArea());
                        }
                        else
                        {
                ...
                case "volume":
                    {
                        var currentAsIVolumeMeasureable = this.currentFigure as IVolumeMeasurable;
                        if (currentAsIVolumeMeasureable != null)
                        {
                            Console.WriteLine("{0:0.00}", currentAsIVolumeMeasureable.GetVolume());
                        }
                        else
                        {
                            Console.WriteLine("undefined");
                ...
                case "normal":
                    {
                        var curnetAsIFlat = this.currentFigure as IFlat;
                        if (curnetAsIFlat != null)
                        {
                            Console.WriteLine("{0}", curnetAsIFlat.GetNormal());
                        }
                        else
                        {
                            Console.WriteLine("undefined");
